...
DynamicBitmapClass::DynamicBitmapClass()
{
	m_vertexBuffer = 0;
	m_indexBuffer = 0;
...
DynamicBitmapClass::DynamicBitmapClass(const DynamicBitmapClass& other)
{
}
...
void DynamicBitmapClass::Shutdown()
{
...
int DynamicBitmapClass::GetIndexCount()
{
	return m_indexCount;
}


ID3D10ShaderResourceView* DynamicBitmapClass::GetTexture()
{
	return m_shaderResourceView;
}

ID3D10Texture2D* DynamicBitmapClass::GetTextureEdit()
{
	return m_Texture;
}
...
bool DynamicBitmapClass::InitializeBuffers(ID3D10Device* device)
{
	VertexType* vertices;
...
void DynamicBitmapClass::ShutdownBuffers()
{
...
bool DynamicBitmapClass::UpdateBuffers(int positionX, int positionY, float scale)
{
	...
	if((positionX == m_previousPosX) && (positionY == m_previousPosY) && (scale == m_previousScale))
	{
		return true;
	}
	...
	float pixel = 0.555*2/m_screenWidth;
	float modifier = pixel * scale; 
...
void DynamicBitmapClass::RenderBuffers(ID3D10Device* device)
{
	unsigned int stride;
	unsigned int offset;
